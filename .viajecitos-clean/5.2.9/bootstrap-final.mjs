...
const VERSION = '5.2.9-swipe-polish';
...
/* ${VERSION}: el color de las acciones permanece oculto mientras la fila está en reposo. */
.vjt-swipe-shell {
  border-radius: 15px;
...
console.log('VJT_SWIPE_VISUAL_FIX_OK', JSON.stringify({
  version: VERSION,
  hiddenAtRest: true,
